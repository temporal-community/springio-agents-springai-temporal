// ABOUTME: Temporal activity implementation for the agent's tools.
...
public class ToolActivitiesImpl implements ToolActivities {
    ...
    public String getIpAddress() {
        ...
        String ip = httpGet("https://icanhazip.com").trim();
    ...
    public String getLocationInfo(String ipAddress) {
        ...
        String response = httpGet("http://ip-api.com/json/" + ipAddress);
    ...
    public String getCoordinates(String city) {
        ...
        String response = httpGet("https://geocoding-api.open-meteo.com/v1/search?name=" + encoded + "&count=1");
